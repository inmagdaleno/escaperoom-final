...
<head>
  ...
  <!-- Preload de imágenes críticas para evitar glitches de carga -->
  <link rel="preload" as="image" href="img/botella.webp">
  <link rel="preload" as="image" href="img/playa.webp">
  <link rel="preload" as="image" href="img/templo.webp">
  <link rel="preload" as="image" href="img/atardecer.webp">
  <link rel="preload" as="image" href="img/jungla.webp">
...
<body>
  ...
  <section id="pantalla-bienvenida" class="pantalla">
       ...
       <!-- Escena Playa -->
  <section id="escena-playa" class="pantalla loading">
    <div class="contenido">
      <h2>La Playa</h2>
